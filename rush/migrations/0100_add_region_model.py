    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_zoom', models.FloatField(help_text='Default zoom level for map view (e.g., 12.0 for city level)', validators=[django.core.validators.MinValueValidator(0.0)])),
            ],
        ),
        migrations.AddField(
            model_name='question',
