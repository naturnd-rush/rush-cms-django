import{g as w}from"./graphql.js";function _(t){let o=0,n=0;for(let r of t)o+=r.x,n+=r.y;return{x:o/=t.length,y:n/=t.length}}function h(t){let o="";for(let n of t)o+=n.x+","+n.y+" ";return o}function v(t){const i=[{x:20,y:20},{x:100,y:40},{x:140,y:80},{x:60,y:120},{x:20,y:80}];let a=`
    <svg 
        width="200px"
        height="150px"
    ...
    `;t.drawStroke&&(a+=`
        ...
        `:a+='fill="none"',a+="/>";const e=_(i);return t.drawMarker&&t.markerOptions.data!==null&&(a+=`
        <circle 
            id="marker-centroid"
            r="20px"
