var d=Object.defineProperty;var l=(r,e,a)=>e in r?d(r,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):r[e]=a;var c=(r,e,a)=>l(r,typeof e!="symbol"?e+"":e,a);import{a as h,Z as u}from"./schema.js";class o extends Error{constructor(e){super(e)}}class f{constructor(e){c(this,"schema");c(this,"metadata");this.schema=e,this.metadata=this.getSchemaMetadata(e)}getSchemaMetadata(e){const a=JSON.parse(e.description??"{}"),t=h.safeParse(a);if(!t.success)throw new Error("Invalid schema metadata: "+JSON.stringify(t.error));return t.data}getSchemaShape(){if(this.schema instanceof u)return this.schema.shape;throw new Error("Schema should always be an instance of a ZodObject, but instead is: "+typeof this.schema+"!")}buildGetById(e){const a=Object.keys(this.getSchemaShape()).join(`
`),s=`
            query ($id: UUID!) {
