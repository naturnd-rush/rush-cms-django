...
It is our belief that the solution space when tackling climate change can be mutually beneficial for all parties involved. For example, local stream restoration groups need volunteers, and spending time in nature leads to [significant physical and mental benefits](https://pmc.ncbi.nlm.nih.gov/articles/PMC11851813/), without even considering the effect of spending this time with your local community and a well-defined purpose. These are the connections, and opportunities, we wish to foster through the RUSH Initiative.
